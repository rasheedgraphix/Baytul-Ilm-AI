...
sealed class Screen(val route: String, val title: String) {
    ...
    object PrayerTimes : Screen("prayer_times", "Prayer Times")
    object Qibla : Screen("qibla", "Qibla Direction")
    object Tasbeeh : Screen("tasbeeh", "Digital Tasbeeh")
    object HijriCalendar : Screen("hijri_calendar", "Hijri Calendar")
    object IslamicTools : Screen("islamic_tools", "Islamic Tools Hub")
    object Ramadan : Screen("ramadan", "Ramadan Calendar")
    object DailyQuran : Screen("daily_quran", "Daily Quran Verse")
    object DailyHadith : Screen("daily_hadith", "Daily Hadith")
    object DailyDua : Screen("daily_dua", "Daily Duas")
    object NamesOfAllah : Screen("names_of_allah", "99 Names of Allah")
    object IslamicEvents : Screen("islamic_events", "Islamic Events")
    object NearbyMosques : Screen("nearby_mosques", "Nearby Mosques")
    object IslamicWallpapers : Screen("islamic_wallpapers", "Islamic Wallpapers")
    object DateConverter : Screen("date_converter", "Date Converter")
